...
struct LoginView: View {
    ...
    @State var showGroupAlert = false
    @State var showGroupAlert1 = false
                ...
                ScrollView(showsIndicators: false){
                    VStack {
                        ...
                        Text("Política de privacidade")
                            ...
                            .foregroundColor(.blue)
                            .padding(.top,17)
                            .sheet(isPresented: $showGroupAlert, content: {
                                ScrollView {
                                    VStack{
                                        Text("\nPrivacy Policy")
                                            .foregroundColor(.blue)
    ...
    For the purposes of this Privacy Policy:
        ...
        -Application means the software program provided by the Company downloaded by You on any electronic device, named Zaitty

        -Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Zaitty.
    ...
    """)
                            ...
                            .onTapGesture {
                                showGroupAlert.toggle()
                            }
                        Text("Time de desenvolvimento")
                            .font(.system(size: 14))
                            .padding(.top,17)
                            .foregroundColor(.blue)
                            .sheet(isPresented: $showGroupAlert1, content: {
                                VStack {
    ...
    Camila Prates Gudolle
    Designer

    Diego Henrique Oliveira
    Desenvolvedor

    Felipe Grosze Nipper de Oliveira
    Desenvolvedor
