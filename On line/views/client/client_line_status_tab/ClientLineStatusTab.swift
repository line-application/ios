...
struct ClientLineStatusTab_Previews: PreviewProvider {
    static var previews: some View {
        ...
        ClientLineStatusTab(currentLine: Binding.constant(nil), lineplace: Binding.constant(LinePlaceModel(id: ", enterLine: "", exitLine: "", called: "", invoked: true, success: false, peopleInLine: 3, businessEmail: "", clientEmail: "", clientName: "")))
    }
}
